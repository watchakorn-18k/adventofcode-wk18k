"""
https://github.com/LuisGC/advent-of-code/blob/main/2023/day-11/main.py
"""
...
with open("input", encoding="utf-8") as f:
    ...
    print("Part 1: Sum of distance of all galaxies is ",
          sum(calculate_distances(input_lines)))
    print("Part 1: Sum of distance of all galaxies if much older is ",
          sum(calculate_distances(input_lines, 1000000)))
