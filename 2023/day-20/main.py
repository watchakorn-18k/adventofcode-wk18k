"""
https://github.com/vil02/adv_2023/blob/main/solutions/adv_2023_20.py
"""
...
class FlipFlop:
    ...
    def _flip(self, circuit):
        new_pulse_type = {FlipFlop._off: _HIGH,
                          FlipFlop._on: _LOW}[self._state]
        self._state = {_HIGH: FlipFlop._on,
                       _LOW: FlipFlop._off}[new_pulse_type]
...
class Conjunction:
    ...
    def receive(self, circuit, in_pulse):
        ...
        new_pulse_type = _LOW if all(
            _ == _HIGH for _ in self._last.values()) else _HIGH
...
with open("input", "r") as f:
    print("PART 1:", solve_a(f.read()))

with open("input", "r") as f:
    print("PART 2:", solve_b(f.read()))
