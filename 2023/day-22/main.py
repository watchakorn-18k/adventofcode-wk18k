"""
https://github.com/vil02/adv_2023/blob/main/solutions/adv_2023_22.py
"""
...
def solve_b(in_str: str):
    ...
    for new_id, brick in enumerate(bricks):
        new_bricks.append(
            Brick(id=new_id, pos_a=brick.pos_a, pos_b=brick.pos_b))
    bricks = new_bricks
...
with open("input", "r") as f:
    in_str = f.read()
    print("PART 1:", solve_a(in_str))
    print("PART 2:", solve_b(in_str))
