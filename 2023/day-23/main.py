"""
https://github.com/LuisGC/advent-of-code/blob/main/2023/day-23/main.py
"""
...
with open("input", encoding="utf-8") as f:
    ...
    print("Part 2: The longest hike without slopes is ",
          longest_hike_without_slopes(input_lines))
